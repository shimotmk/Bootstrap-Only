...
function the_content( $more_link_text = null, $strip_teaser = false ) {
	...
	*/
	...
	$content = str_replace( '<h2' , '<h2 class="border-left border-primary px-5 my-3 bg-light text-break" ',$content);
	$content = str_replace( '<h3' , '<h3 class="border-left border-primary px-3 mb-5 text-break" ',$content);
